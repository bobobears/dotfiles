...
Outside of code bugs, three common scenarios have dedicated references under this skill:

- **`references/diagnosing-hung-processes.md`** — "Is this process still alive or is it stuck?" Triage flow using wchan, pstree, /proc, network connections, and cache inspection. Use whenever a user reports a long-running or unresponsive process (npm ci, pip install, build scripts, server startup).
